...
public class EmptyRecyclerView extends RecyclerView
{
    ...
    void checkEmpty()
    {
        if (emptyView != null && getAdapter() != null) {
            ...
            if (speedView != null) {
                speedView.setVisibility(isEmptyViewVisible ? GONE : VISIBLE);
                setVisibility(isEmptyViewVisible ? GONE : VISIBLE);
            }
        }
    }
    ...
    public void setEmptyView(View emptyView,View speedView)
{
    ...
    public void setEmptyViewDetail(View emptyView)
    {
        this.emptyView = emptyView;
        checkEmpty();
    }
