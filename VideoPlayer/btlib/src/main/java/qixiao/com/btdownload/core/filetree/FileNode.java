...
package qixiao.com.btdownload.core.filetree;
...
public interface FileNode<F> extends Comparable<F>
{
    class Type implements Serializable
    {
        ...
        public static int FILE = 1;//未知
        public static int MP3 = 2;
        public static int MP4 = 3;
        public static int TXT = 4;//.txt   .doc  .docs
        public static int APK = 5;
        public static int ZIP = 6;//.rar   .zip
        public static int PNG = 7;//.png   .jpg   .gif
