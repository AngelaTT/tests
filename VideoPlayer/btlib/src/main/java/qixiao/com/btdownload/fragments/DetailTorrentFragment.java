...
import qixiao.com.btdownload.adapters.ViewPagerAdapter;
import qixiao.com.btdownload.core.BencodeFileItem;
import qixiao.com.btdownload.core.Torrent;
import qixiao.com.btdownload.core.TorrentMetaInfo;
import qixiao.com.btdownload.core.TorrentStateCode;
import qixiao.com.btdownload.core.stateparcel.PeerStateParcel;
import qixiao.com.btdownload.core.stateparcel.StateParcelCache;
import qixiao.com.btdownload.core.stateparcel.TorrentStateParcel;
import qixiao.com.btdownload.core.TorrentTaskServiceIPC;
import qixiao.com.btdownload.core.stateparcel.TrackerStateParcel;
import qixiao.com.btdownload.core.storage.TorrentStorage;
        ...
        BaseAlertDialog.OnDialogShowListener
{
    ...
    public void openFile(String relativePath)
    {
        ...
        /* Give user a choice than to pause file (without determining MIME type) */
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        } else if (i == R.id.pause_resume_torrent_menu) {
            pauseResumeTorrentRequest();

        } else if (i == R.id.delete_torrent_menu) {
        ...
        } else if (i == R.id.force_recheck_torrent_menu) {
            forceRecheckRequest();

        } else if (i == R.id.force_announce_torrent_menu) {
            forceAnnounceRequest();

        } else if (i == R.id.share_magnet_menu) {
            getMagnetRequest();

        } else if (i == R.id.save_torrent_file_menu) {
            torrentSaveChooseDialog();

        } else if (i == R.id.add_trackers_menu) {
        ...
        } else if (i == R.id.torrent_speed_limit) {
