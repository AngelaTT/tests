...
package qixiao.com.btdownload.core;
...
public class TorrentTaskServiceIPC
{
    ...
    public static final int RESUME_TORRENTS = 28;
    public static final int PAUSE_TORRENTS = 29 ;
    ...
    public void sendPauseTorrents(Messenger serviceCallback,
                                        ArrayList<String> torrentIds) throws RemoteException
    {
        if (serviceCallback == null) {
            return;
        ...
        Message msg = Message.obtain(null, PAUSE_TORRENTS, null);
        msg.getData().putStringArrayList(TAG_TORRENT_IDS_LIST, new ArrayList<>(torrentIds));

        serviceCallback.send(msg);
    }

    public void sendResumeTorrents(Messenger serviceCallback,
                                  ArrayList<String> torrentIds) throws RemoteException
    {
        if (serviceCallback == null) {
            return;
        ...
        Message msg = Message.obtain(null, RESUME_TORRENTS, null);
        msg.getData().putStringArrayList(TAG_TORRENT_IDS_LIST, new ArrayList<>(torrentIds));
